...
class GeneratePageListener
{
    ...
    protected function setMetaInformation()
    {
        ...
        $GLOBALS['objPage']->pageTitle = strip_tags(StringUtil::decodeEntities($GLOBALS['CM_MASTER']['roleResolver']()->getValueByRole('metaTitle') ?: $GLOBALS['CM_MASTER']['roleResolver']()->getValueByRole('title')));
        $GLOBALS['objPage']->description = strip_tags(StringUtil::decodeEntities((($GLOBALS['CM_MASTER']['roleResolver']()->getValueByRole('metaDescription') ?: $GLOBALS['CM_MASTER']['roleResolver']()->getValueByRole('description')))));
